...
var Bar = function (_Group) {
  ...
  function Bar(data) {
    ...
    var lmin = Math.min.apply(null, data.datasets[0].data);
    var lmax = Math.max.apply(null, data.datasets[0].data);
...
var OneBar = function (_Group2) {
  ...
  function OneBar(index, value, subIndex, tooltip, scale, color, xScale, size, bottomY, interval, len, label, gLabel) {
    ...
    var from = Object.assign({}, { scaleY: 0 });
    var to = Object.assign({}, { scaleY: 1 });
    ...
    _cax2.default.To.get(from).wait(subIndex * 150 + index * 150).to(to, 2000, _cax2.default.easing.elasticOut).progress(function (object) {
      // console.log(rect)
      // console.log(object)
