...
cax.Group.prototype.addChild = cax.Group.prototype.add;
cax.Group.prototype.removeChild = cax.Group.prototype.remove;

if (typeof window !== 'undefined') {
  var createjs = {
    Container: cax.Group,
    Text: function Text(text, font, color) {
      return new cax.Text(text, { font: font, color: color });
    },
    Stage: cax.Stage
  };
