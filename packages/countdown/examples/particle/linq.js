...
(function (window, namespace) {
  ...
  JSLINQ.prototype = {
    ...
    Reverse: function () {
      var retVal = []
      for (var index = this.items.length - 1; index > -1; index--) { retVal[retVal.length] = this.items[index] }
      return new JSLINQ(retVal)
    },
    First: function (clause) {
      if (clause != null) {
        ...
        if (this.items.length > 0) { return this.items[0] } else { return null }
      }
    },
    Last: function (clause) {
      if (clause != null) {
        ...
        // If no clause was specified, then return the First element in the Array
        if (this.items.length > 0) { return this.items[this.items.length - 1] } else { return null }
      }
    },
