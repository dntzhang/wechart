...
var stage = new _cax2.default.Stage(700, 420, '#canvasCtn');
...
var Ellipse = _cax2.default.Ellipse,
    Graphics = _cax2.default.Graphics,
    Group = _cax2.default.Group;

var Cylinder = function (_Group) {
    _inherits(Cylinder, _Group);

    function Cylinder(width, height, percent, color, bottleColor) {
        ...
        var topEllipse = new Ellipse(width, width / 2.5, {
            fillStyle: bottleColor
        });
        topEllipse.y = shortSize * -1;

        var middleEllipse = new Ellipse(width, width / 2.5, {
            fillStyle: color
        });
        middleEllipse.y = th - shortSize;

        var middleEllipseMask = new Ellipse(width, width / 2.5, {
            fillStyle: bottleColor
        });
        middleEllipseMask.alpha = 0.618;
        middleEllipseMask.y = th - shortSize;

        var bottomEllipse = new Ellipse(width, width / 2.5, {
            fillStyle: color
        });
        bottomEllipse.y = height - shortSize;

        _this.add(topRect, topEllipse, btRect, bottomEllipse, middleEllipse, middleEllipseMask);
        return _this;
    }
