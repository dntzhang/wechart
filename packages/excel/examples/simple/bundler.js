...
var Excel = function (_Group) {
  _inherits(Excel, _Group);

  function Excel(data, option) {
    ...
    _this.colCount = option.colWidth.length;
    _this.rowCount = option.rowHeight.length;
  ...
  _createClass(Excel, [{
    ...
    value: function _processOffset(option) {
      var offsetX = [0];
      for (var i = 0, length = option.colWidth.length; i < length - 1; i++) {
    ...
    key: '_getY',
    value: function _getY(verticalAlign, rowHeight, lineHeight, offsetY) {
