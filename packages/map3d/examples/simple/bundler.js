...
var _pasition = __webpack_require__(1);

var _pasition2 = _interopRequireDefault(_pasition);

var _china = __webpack_require__(2);
...
var shapes = _china2.default.shapes;
var cityList = [];

for (var city in shapes) {
  cityList.push({ city: city, curves: _pasition2.default.path2shapes(shapes[city])[0] });
}

cityList.forEach(function (city, aa) {

  var heartShape = new THREE.Shape();
  city.curves.forEach(function (curve, index) {
