...
var WordCloud = function (_Group) {
  _inherits(WordCloud, _Group);

  function WordCloud(data, option) {
    _classCallCheck(this, WordCloud);

    var _this = _possibleConstructorReturn(this, (WordCloud.__proto__ || Object.getPrototypeOf(WordCloud)).call(this));
    ...
    _this.offScreenCanvas.width = 400;
    _this.offScreenCanvas.height = 400;
    _this.offScreenCtx = _this.offScreenCanvas.getContext('2d');

    //debug
    document.body.appendChild(_this.offScreenCanvas);

    _this.compositeCanvas = document.createElement('canvas');
    _this.compositeCanvas.width = 400;
