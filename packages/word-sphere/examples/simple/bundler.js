...
var WordSphere = function (_Group) {
  ...
  function WordSphere(data, option) {
    _classCallCheck(this, WordSphere);

    var _this = _possibleConstructorReturn(this, (WordSphere.__proto__ || Object.getPrototypeOf(WordSphere)).call(this));

    _this.data = data;
    _this.option = option;

    _this.center = { x: 300, y: 300, z: 0 };
    _this.cameraPosition = { x: 300, y: 300, z: 500 };
    _this.r = 250;
    _this.distance = 300;
    _this.positions = [];
    _this.rdPositions = [];
  ...
  _createClass(WordSphere, [{
    ...
    value: function render() {
      ...
      this.children.forEach(function (child, index) {
        // console.log(index)
        _this3.transform(child, index);
      });
    }
  }, {
    key: 'transform',
    value: function transform(text, i) {

      var z = this.positions[i].z;
